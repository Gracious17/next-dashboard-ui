...
const forms: {
  ...
  teacher: (type, data) => (
    <TeacherForm type={type} data={data} name="Teacher" />
  ),
  student: (type, data) => (
    <StudentForm type={type} data={data} name="student" />
  ),
  parent: (type, data) => <ParentForm type={type} data={data} name="parent" />,
};
const FormModal = ({
  table,
  type,
        ...
        <div className="h-screen w-screen absolute left-0 top-0 bg-black bg-opacity-60 z-50 flex items-center justify-center ">
          <div className="bg-white p-4 rounded-md relative w-[90%] md:w-[70%] lg:w-[60%] xl:w-[50%] 2xl:w-[40%] ">
            ...
            <div
              ...
              className="absolute top-4 right-4 cursor-pointer pt-20"
            >
